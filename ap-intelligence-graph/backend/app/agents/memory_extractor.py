...
def extract_candidate_claims(message: str, client_id: str, client_name: str) -> tuple[list[dict], str]:
    claims, provider_name = call_with_fallback("extract_claims", message, client_id, client_name)
